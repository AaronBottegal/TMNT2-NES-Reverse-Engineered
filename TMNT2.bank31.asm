...
OBJ_HANDLERS_POSITIVE_H: ; 1F:112A, 0x03F12A
    ...
    LOW(OBJ_STATE_0x02_HANDLER) ; 0x02 <<In progress. Even just this has a lot of shit in it.
    ...
    HIGH(OBJ_STATE_0x6A_HANDLER)
    LOW(OBJ_STATE_0x6D_HANDLER) ; 0x6D, Also fucked up, but -1.
...
L_1F:15BE: ; 1F:15BE, 0x03F5BE
    ...
    STA 4D8_OBJ_UNK[18],X
    LDA 4C6_OBJ_UNK[18],X
    ADC 532_OBJ_UNK_POS_DELTA?[18],X
    STA 4C6_OBJ_UNK[18],X
    RTS
...
L_1F:164C: ; 1F:164C, 0x03F64C
    ...
    STA 556_OBJ_UPDATE_FLAGS?[18],X
    RTS
UPDATE_PALETTE[0x1C]_WITH_A_SAVING_XOBJ: ; 1F:1655, 0x03F655
    TXA ; Save X.
    PHA
    TYA ; Y to A.
...
MOVE_UNK_RET_??: ; 1F:1895, 0x03F895
    ...
    EOR 50E_ARR_UNK[18],X ; Exclusive or with.
    ASL A ; Shift back.
    RTS ; Leave.
