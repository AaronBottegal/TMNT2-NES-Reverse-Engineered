...
RTN_UNK: ; 13:0F39, 0x026F39
    ...
    STA ARR_OBJECT_ENABLED+MORE?+2,X
    STA OBJ_ANIMATION_FRAME_TO[18],X
    STA OBJ_ANIMATION_FRAME_TO+2,X
    RTS
...
SWITCH_RTN_C: ; 13:102D, 0x02702D
    ...
    LDA #$BE
    STA OBJ_ANIMATION_FRAME_TO+1
    LDA #$C0
    STA OBJ_ANIMATION_FRAME_TO+3
    LDA $B0F6
    STA 4FC_ARR_UNK+1
    LDA $B0F7
    STA 4EA_ARR_UNK+1
...
4B_SWITCH: ; 13:16F2, 0x0276F2
    LDA 4B_SWITCH_GAME_OVER/FINISHED ; Switch on var.
    JSR SWITCH_CODE_PTRS_PAST_JSR
...
SWITCH_RTN_A: ; 13:170D, 0x02770D
    ...
    INC 4B_SWITCH_GAME_OVER/FINISHED ; Switch++
...
SWITCH_RTN_B: ; 13:1720, 0x027720
    ...
    INC 4B_SWITCH_GAME_OVER/FINISHED ; Next switch.
...
SWITCH_RTN_D: ; 13:1746, 0x027746
    ...
    LDA #$15
    JSR UNK_STREAM_0x300_SETUP_BANK_1C/1D ; Set up ??
    LDX #$07 ; Obj start.
    LDY #$00 ; Data.
LOOP_ALL_OBJS: ; 13:1752, 0x027752
    LDA #$70 ; Load 0111.0000
    STA ARR_OBJECT_ENABLED+MORE?[18],X ; Store to obj.
    ...
    STA OBJ_ANIMATION_FRAME_TO[18],X ; Set animation frame?
    LDA #$00
    STA 556_ARR_UNK[18],X ; Clear.
...
SWITCH_RTN_E: ; 13:17A8, 0x0277A8
    ...
    JSR RTN_OBJS_UNK ; Do..
    LDA #$05
    JSR UNK_STREAM_0x300_SETUP_BANK_1C/1D ; Set up stream.
    INC 4B_SWITCH_GAME_OVER/FINISHED ; Next switch.
    LDA #$68 ; Play sound.
...
UPLOAD_DATA: ; 13:1806, 0x027806
    LDA #$05
    JSR UNK_STREAM_0x300_SETUP_BANK_1C/1D ; Upload data.
...
SEL/U/D_NOT_PRESSED: ; 13:18AD, 0x0278AD
    ...
    LDA #$74
    STA OBJ_ANIMATION_FRAME_TO[18] ; Set to.
    LDA #$C4
...
SWITCH_RTN_K: ; 13:18DB, 0x0278DB
    ...
    LDA LEVEL_SCREEN_ON ; Game continuue. Load screen on.
    CMP #$01 ; If _ #$01
    BNE DONT_DEC_3D3
    DEC LEVEL_SCREEN_ON ; Screen 1 is first level, set to 0.
...
VAL_UNDER_C: ; 13:190C, 0x02790C
    CLC
    ADC #$21 ; += #$21.
    STA ARR_6D7_UNK+3,Y ; To objects..?
    STA ARR_6D7_UNK+4,Y
    STA ARR_6D7_UNK+5,Y
    LDA #$0F
