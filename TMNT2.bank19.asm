...
RTN_UNK: ; 13:0F39, 0x026F39
    ...
    STA 400_ARR_SPR_ANIM_FRAME_WHICH?+2,X
    RTS
...
SWITCH_RTN_C: ; 13:102D, 0x02702D
    ...
    LDA #$BE
    STA 400_ARR_SPR_ANIM_FRAME_WHICH?+1
    LDA #$C0
    STA 400_ARR_SPR_ANIM_FRAME_WHICH?+3
    LDA $B0F6
    STA 4FC_ARR_UNK+1
    LDA $B0F7
    STA 4EA_ARR_UNK+1
    ...
    LDA #$C1
    STA 400_ARR_SPR_ANIM_FRAME_WHICH?+2
    LDA $B4ED
    STA 58C_ARR_UNK[18]
    LDA $B4EE
    STA 59E_ARR_UNK[18]
...
SWITCH_RTN_I: ; 13:1889, 0x027889
    ...
    STA 47E_ARR_UNK[18]
    LDA #$74
    STA 400_ARR_SPR_ANIM_FRAME_WHICH?[18]
    LDA #$C4
    STA ZP_R2-R5_BANK_VALUES[4]
    LDX **:$0655
    LDA $B8C5,X
