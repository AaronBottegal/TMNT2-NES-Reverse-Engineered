...
STATE_0x71_SUBSWITCH_C: ; 17:0177, 0x02E177
    ...
    SEC
    LDA OBJ_POS_Y??+17,X ; -1Pair load.
    SBC OBJ_POS_X?[18],X ; Suub with.
    BPL RESULT_POSITIVE
    EOR #$FF ; Compliment.
    CLC
    ADC #$01
...
STATE_0x75_SWITCH_B: ; 17:0593, 0x02E593
    LDA #$DC
    STA ZP_R2-R5_BANK_VALUES+2 ; Mod GFX.
    LDA #$DD
    STA ZP_R2-R5_BANK_VALUES+3
...
SWITCH_0x75_RTN_D_ALT_E: ; 17:074F, 0x02E74F
    ...
    LDA OBJ_POS_X?[18],X ; Move attrs to new.
    STA OBJ_POS_X?[18],Y
    LDA OBJ_POS_X??[18],X
    STA OBJ_POS_X??[18],Y
    SEC ; Prep sub.
