...
SET_UP_TURTLE_2_FROM_P1_DATA: ; 1C:0145, 0x038145
    ...
    LDA #$01
    STA OBJ_STATE_DIR_RELATED_C[18],X ; Set looking to right?
...
PLAYER_REINIT_RTN?: ; 1C:0164, 0x038164
    ...
    STA OBJ_STATE_DIR_RELATED_C[18],X ; Clear object var.
...
B_BUTTON_PRESSED: ; 1C:046D, 0x03846D
    ...
    LDA OBJ_STATE_DIR_RELATED_C[18],X ; Load val.
...
STORE_A_TO_OBJ_UNK: ; 1C:0485, 0x038485
    STA OBJ_STATE_DIR_RELATED_C[18],X ; Store L/R value decided.
...
P_VAL_60_ZERO: ; 1C:074C, 0x03874C
    LDA OBJ_POS_Y?[18],X ; Load object val.
    CMP #$CF ; If _ #$CF
...
L_1C:0BA7: ; 1C:0BA7, 0x038BA7
    ...
    AND #$40
    ORA OBJ_STATE_DIR_RELATED_C[18],X
    STA OBJ_STATE_DIR_RELATED_C[18],X
    LDA OBJ_STATE_DIR_RELATED_C[18],X
    AND #$40
    BEQ L_1C:0BDE
