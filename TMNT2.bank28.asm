    .db 3C
PREMADE_UPDATE_BUF_QUEUE: ; 1C:0001, 0x038001
    ASL A ; Shift A, make index.
    TAY ; To Y.
    LDA PREMADE_PPU_UPDATE_PTRS_L,Y ; Load low.
    STA TMP_00
    LDA PREMADE_PPU_UPDATE_PTRS_H,Y ; Load high.
    STA TMP_01
    LDA #$FF ; Mask set.
...
OUTPUT_PACKET_HEADER: ; 1C:0015, 0x038015
    ...
    LDA [TMP_00],Y ; Load.
    JSR A_TO_PPU_UPDATE_BUFFER ; To buffer, addr low.
    INY ; Stream++
    LDA [TMP_00],Y ; Load from stream.
    JSR A_TO_PPU_UPDATE_BUFFER ; To buffer, addr high.
    INY ; Steam++
APPEND_PACKET_DATA: ; 1C:0026, 0x038026
    LDA [TMP_00],Y ; Load from stream.
    INY ; Stream++
    CMP #$FF ; If A _ 0xFF. EOF Marker for data.
    BEQ WRITE_0xFF_TO_UPDATE_BUF_REINDEXED ; ==, goto. 2 mistakes, A reload, reindexing. Leaves.
    CMP #$FE ; If A_ 0xFE.
    BEQ END_PACKET_OUTPUT_ANOTHER ; ==, goto.
    AND TMP_02 ; Mask tile? Unused feature?
    JSR A_TO_PPU_UPDATE_BUFFER ; Store.
    JMP APPEND_PACKET_DATA ; Goto.
END_PACKET_OUTPUT_ANOTHER: ; 1C:0039, 0x038039
    JSR WRITE_0xFF_TO_UPDATE_BUF_REINDEXED ; Write 0xFF.
    JMP OUTPUT_PACKET_HEADER ; Continue.
WRITE_0xFF_TO_UPDATE_BUF_REINDEXED: ; 1C:003F, 0x03803F
    LDA #$FF ; Write to buffer.
...
A_TO_PPU_UPDATE_BUFFER: ; 1C:0043, 0x038043
    ...
    RTS ; Leave.
PREMADE_PPU_UPDATE_PTRS_L: ; 1C:004A, 0x03804A
    LOW(UPDATE_ENTRY_A) ; 0x00: "1 Turtle"
PREMADE_PPU_UPDATE_PTRS_H: ; 1C:004B, 0x03804B
    HIGH(UPDATE_ENTRY_A)
    LOW(UPDATE_ENTRY_B) ; 0x01: "2 Turtles"
    HIGH(UPDATE_ENTRY_B)
    LOW(UPDATE_ENTRY_C) ; 0x02: Older copyright text. "C KONAMI 1989"
    HIGH(UPDATE_ENTRY_C)
    LOW(UPDATE_ENTRY_D) ; 0x03:
    HIGH(UPDATE_ENTRY_D)
    ...
    HIGH(UPDATE_ENTRY_F)
    LOW(UPDATE_ENTRY_G) ; 0x07:"CONTINUE", "END"
    HIGH(UPDATE_ENTRY_G)
    LOW(UPDATE_ENTRY_H) ; 0x08: "BANK 0"
    HIGH(UPDATE_ENTRY_H)
    LOW(UPDATE_ENTRY_I) ; 0x09: "BANK 1"
    HIGH(UPDATE_ENTRY_I)
    LOW(UPDATE_ENTRY_J) ; 0x0A: "BANK 2"
    HIGH(UPDATE_ENTRY_J)
    LOW(UPDATE_ENTRY_K) ; 0x0B: "BANK 3"
    HIGH(UPDATE_ENTRY_K)
    LOW(UPDATE_ENTRY_L) ; 0x0C: "FILE"
    HIGH(UPDATE_ENTRY_L)
    LOW(UPDATE_ENTRY_M) ; 0x0D: "CHR"
    HIGH(UPDATE_ENTRY_M)
    LOW(UPDATE_ENTRY_N) ; 0x0E: "STAGE SELECT"
    HIGH(UPDATE_ENTRY_N)
    LOW(UPDATE_ENTRY_C) ; 0x0F: "PLAY SELECT"
    HIGH(UPDATE_ENTRY_C)
    LOW(UPDATE_ENTRY_C) ; 0x10: "PLAY SELECT"
    HIGH(UPDATE_ENTRY_C)
    LOW(UPDATE_ENTRY_C) ; 0x11: "PLAY SELECT"
    HIGH(UPDATE_ENTRY_C)
    LOW(UPDATE_ENTRY_C) ; 0x12: "PLAY SELECT"
    HIGH(UPDATE_ENTRY_C)
    LOW(UPDATE_ENTRY_O) ; 0x13: "OFF"
    HIGH(UPDATE_ENTRY_O)
    LOW(UPDATE_ENTRY_P) ; 0x14: "ON "
    HIGH(UPDATE_ENTRY_P)
    LOW(UPDATE_ENTRY_Q) ; 0x15: GFX square, unk rn.
    HIGH(UPDATE_ENTRY_Q)
UPDATE_ENTRY_C: ; 1C:0076, 0x038076
    .db 8A
    .db 22
    .db 1A
    .db 16
    ...
    .db 1E
    .db FF
UPDATE_ENTRY_D: ; 1C:0084, 0x038084
    .db E9
    .db 21
    .db 61
    .db 00
    ...
    .db 39
    .db FF
UPDATE_ENTRY_A: ; 1C:0094, 0x038094
    .db CC
    .db 22
    .db 02
    .db 00
    ...
    .db 0F
    .db FF
UPDATE_ENTRY_B: ; 1C:009F, 0x03809F
    .db 0C
    .db 23
    .db 03
    .db 00
    ...
    .db 1D
    .db FF
UPDATE_ENTRY_F: ; 1C:00AB, 0x0380AB
    .db 6C
    .db 21
    .db 11
    .db 0B
    ...
    .db 1C
    .db FF
UPDATE_ENTRY_G: ; 1C:00B7, 0x0380B7
    .db 8B
    .db 21
    .db 0D
    .db 19
    ...
    .db 0E
    .db FF
UPDATE_ENTRY_Q: ; 1C:00CA, 0x0380CA
    .db 88
    .db 21
    .db C6
    .db 00
    ...
    .db 0E
    .db FF
UPDATE_ENTRY_H: ; 1C:00E3, 0x0380E3
    .db 63
    .db 20
    .db 26
    .db 25
    ...
    .db 01
    .db FF
UPDATE_ENTRY_I: ; 1C:00EC, 0x0380EC
    .db 63
    .db 20
    .db 26
    .db 25
    ...
    .db 02
    .db FF
UPDATE_ENTRY_J: ; 1C:00F5, 0x0380F5
    .db 63
    .db 20
    .db 26
    .db 25
    ...
    .db 03
    .db FF
UPDATE_ENTRY_K: ; 1C:00FE, 0x0380FE
    .db 63
    .db 20
    .db 26
    .db 25
    ...
    .db 04
    .db FF
UPDATE_ENTRY_L: ; 1C:0107, 0x038107
    .db 6B
    .db 20
    .db 2A
    .db 2D
    ...
    .db 29
    .db FF
UPDATE_ENTRY_M: ; 1C:010E, 0x03810E
    .db 74
    .db 20
    .db 27
    .db 2C
    .db 36
    .db FF
UPDATE_ENTRY_N: ; 1C:0114, 0x038114
    .db 2A
    .db 21
    .db 1D
    .db 1E
    ...
    .db 1E
    .db FF
UPDATE_ENTRY_O: ; 1C:0123, 0x038123
    .db 8E
    .db 22
    .db 19
    .db 10
    .db 10
    .db FF
UPDATE_ENTRY_P: ; 1C:0129, 0x038129
    .db 8E
    .db 22
    .db 19
    .db 18
    .db 00
    .db FF
UPDATE_ENTRY_E: ; 1C:012F, 0x03812F
    .db 00
    .db 3F
    .db FE
    .db 00
...
SET_UP_TURTLE_2_FROM_P1_DATA: ; 1C:0145, 0x038145
    ...
    LDA #$01
    STA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X ; Set looking to right?
    LDA TURTLE_SELECTION+1 ; Load turtle selected.
    ASL A ; << 2, *4.
    ASL A
    TAY ; To Y index.
    ...
    SEC
    SBC #$24 ; -= 0x24
    STA OBJ_POS_X_CONFIRMED[18],X ; Store to objs.
    STA OBJ_POS_X_CONFIRMED+1,X
    RTS
PLAYER_REINIT_RTN?: ; 1C:0164, 0x038164
    LDA #$00
    STA 85_PLAYER_UNK?[2],Y ; Clear unk, player val.
    STA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X ; Clear object var.
    LDA TURTLE_SELECTION[2] ; Load turtle select position for P1.
...
42_NOT_THREE: ; 1C:01A0, 0x0381A0
    TYA ; Y to A, #$00 or #$F0.
    STA 4C6_OBJ_UNK[18],X ; To object.
    JSR UPDATE_PLAYER_HEALTH ; Update..
    LDA LEVEL/SCREEN_ON ; Load
    CMP #$07 ; If _ #$07
    BNE RTS ; !=, goto.
...
INIT_PLAYER_THINGS?: ; 1C:0223, 0x038223
    ...
    LDA #$01
    JSR BANKED_PLAYER_UI_GAME_OVER_GFX ; P2 num lives?
    TXA ; Save X.
    PHA
    LDX #$02
...
A_NOT_PRESSED: ; 1C:0268, 0x038268
    LDA TWO_PLAYERS_FLAG ; Test if 2P.
    BEQ RTS ; No, leave.
    LDY #$01 ; Player focus.
    LDX #$02 ; P2 data?
    LDA NUM_PLAYER_LIVES+1 ; Load P2 lives.
...
P2_A_BUTTON_PRESSED: ; 1C:027B, 0x03827B
    ...
    LDA #$01
    JSR BANKED_PLAYER_UI_GAME_OVER_GFX ; Set up P2 info.
    TXA ; Save X.
    PHA
    LDX #$00 ; Do P1.
...
ANIMATE_UPDATE_P1_O2?: ; 1C:02F5, 0x0382F5
    ...
    JSR UPDATE_PLAYER_HEALTH ; Update idk.
...
CTRL_BUTTONS_ACTION: ; 1C:037D, 0x03837D
    ...
    AND #$BF
    JMP $839C
L_1C:0397: ; 1C:0397, 0x038397
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
    ORA #$40
    STA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
L_1C:039F: ; 1C:039F, 0x03839F
    JSR $8349
...
RTN_STATE_BIT_#$01_SET: ; 1C:03CB, 0x0383CB
    .db 4C ; Goto.
    LSR 84_UNK
L_1C:03CE: ; 1C:03CE, 0x0383CE
    LDA CTRL_NEWLY_PRESSED_A[2],Y
    AND #$80
    BNE L_1C:03D8
    JMP $8811
L_1C:03D8: ; 1C:03D8, 0x0383D8
    LDA 4C6_OBJ_UNK[18],X
...
L_1C:0410: ; 1C:0410, 0x038410
    ...
    LDA #$0E
    BNE L_1C:043C
L_1C:043A: ; 1C:043A, 0x03843A
    LDA #$09
L_1C:043C: ; 1C:043C, 0x03843C
    INX
    JSR $9627
    DEX
L_1C:0441: ; 1C:0441, 0x038441
    LDA #$90
    JMP $9627
...
B_BUTTON_PRESSED: ; 1C:046D, 0x03846D
    ...
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X ; Load val.
...
STORE_A_TO_OBJ_UNK: ; 1C:0485, 0x038485
    STA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X ; Store L/R value decided.
L/R_UNPRESSED: ; 1C:0488, 0x038488
    ...
    LDA TURTLE_SELECTION[2],Y ; Load focused selected.
    TAY ; To Y index.
...
BIT_0x40_NOT_SET: ; 1C:04B2, 0x0384B2
    ...
    TYA ; Y decided to A.
    CLC
    ADC OBJ_POS_X_CONFIRMED[18],X ; Add with val.
...
BIT_0x40_NOT_SET: ; 1C:04F5, 0x0384F5
    ...
    STA 520_OBJ_POS_X_LARGE?[18],X
    STA 503_OBJ_POS_X_LARGEST?[18],X
    STA 520_OBJ_POS_X_LARGE?+1,X ; Clear in other obj..? Seems to be other player related obj, but !sure yet.
    STA 503_OBJ_POS_X_LARGEST?+1,X
    LDA #$05
...
L_1C:0605: ; 1C:0605, 0x038605
    ...
    CMP #$97
    BCC L_1C:0645
L_1C:0618: ; 1C:0618, 0x038618
    LDA 601_IRQ_FLAG_DELAY_MOD_+
    BPL L_1C:0624
    LDA OBJ_POS_X??[18],X
    CMP #$9A
    BCC L_1C:0645
L_1C:0624: ; 1C:0624, 0x038624
    LDA OBJ_POS_X??[18],X
    CMP #$58
    BCC L_1C:0645
    LDY TMP_08
...
L_1C:063E: ; 1C:063E, 0x03863E
    LDA #$89
    JSR RTN_UNK_RTS_CARRY_SET_FAIL?
    BCC RTN_STATE_BIT_0x08
L_1C:0645: ; 1C:0645, 0x038645
    LDA TMP_02
    AND #$F7
    STA TMP_02
    JMP $868C
L_1C:064E: ; 1C:064E, 0x03864E
    LDA TMP_02
    AND #$04
...
L_1C:0660: ; 1C:0660, 0x038660
    ...
    ORA #$07
    STA TMP_02
L_1C:067F: ; 1C:067F, 0x03867F
    LDA OBJ_POS_X??[18],X
    CMP #$E0
    BCC RTN_STATE_BIT_0x08
L_1C:0686: ; 1C:0686, 0x038686
    LDA TMP_02
    AND #$FB
    STA TMP_02
RTN_STATE_BIT_0x08: ; 1C:068C, 0x03868C
    ...
    STA OBJ_POS_X_SUBPIXEL_DELTA?[18],X ; Store to obj/obj+1
    STA OBJ_POS_X_SUBPIXEL_DELTA?+1,X
    LDA DATA_UNK_B,Y ; Load
    STA OBJ_POS_X_DELTA?[18],X ; Same
    STA OBJ_POS_X_DELTA?+1,X
    LDA DATA_UNK_C,Y ; Load
    STA 520_OBJ_POS_X_LARGE?[18],X ; Same
    STA 520_OBJ_POS_X_LARGE?+1,X
    LDA DATA_UNK_D,Y ; Load
    STA 503_OBJ_POS_X_LARGEST?[18],X ; Same
    STA 503_OBJ_POS_X_LARGEST?+1,X
    LDA OBJ_POS_X_SUBPIXEL_DELTA?[18],X ; Load
    ORA OBJ_POS_X_DELTA?[18],X ; Combine with.
    BEQ OBJ_NEXT_UNK ; No bits set, goto.
    LDY TMP_08 ; Get player focus.
    LDA 43_PLAYER_UNK[2],Y ; Load val
    BEQ OBJ_NEXT_UNK ; If not set, goto.
    LDA #$F0 ; Load
    STA OBJ_POS_X_SUBPIXEL_DELTA?[18],X ; Set obj.
    STA OBJ_POS_X_SUBPIXEL_DELTA?+1,X
    LDA #$00 ; Clear
    STA OBJ_POS_X_DELTA?[18],X ; Clear obj.
    STA OBJ_POS_X_DELTA?+1,X
...
COMMIT_A_TO_OBJ: ; 1C:06E7, 0x0386E7
    ...
    DEX ; Obj--?
    LDA 544_OBJ_UNK_POS_DELTA?[18],X ; Load from.
    CLC
    ADC 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X ; Add with.
...
VAR_ABOVE_2C: ; 1C:070D, 0x03870D
    LDA 532_OBJ_UNK_POS_DELTA?[18],X ; Load value.
    CMP #$FC ; If _ #$FC
    BCS L_1C:0715 ; >=, goto.
    RTS ; <, RTS as-is. NOTE: Carry clear might be important.
L_1C:0715: ; 1C:0715, 0x038715
...
VAL_CARRY_POSITIVE: ; 1C:0737, 0x038737
    ...
    LDA OBJ_POS_Y_CONFIRMED[18],X ; Load val.
...
P_VAL_60_ZERO: ; 1C:074C, 0x03874C
    LDA OBJ_POS_X??[18],X ; Load object val.
    CMP #$CF ; If _ #$CF
    ...
    CMP 4C6_OBJ_UNK[18],X ; If _ Obj val.
    BCS RTN_RETURNED_CC ; >=, goto.
    STA 4C6_OBJ_UNK[18],X ; Replace object with loaded.
    JMP L_1C:077B ; Goto.
...
L_1C:0792: ; 1C:0792, 0x038792
    ...
    JSR OBJECT_TO_STATE_A_COMPLEX?
    JMP L_1C:07A7
L_1C:07A0: ; 1C:07A0, 0x0387A0
    INX
    LDA #$00
    JSR OBJECT_TO_STATE_A_COMPLEX?
    DEX
L_1C:07A7: ; 1C:07A7, 0x0387A7
    LDA #$00
    STA OBJ_POS_X_SUBPIXEL_DELTA?+1,X
    STA OBJ_POS_X_DELTA?+1,X
    STA 520_OBJ_POS_X_LARGE?+1,X
...
L_1C:0ACA: ; 1C:0ACA, 0x038ACA
    ...
    STA OBJ_POS_X_DELTA?[18],X
    LDA #$A0
L_1C:0AD9: ; 1C:0AD9, 0x038AD9
    STA OBJ_POS_X_SUBPIXEL_DELTA?[18],X
    BNE L_1C:0AE6
L_1C:0ADE: ; 1C:0ADE, 0x038ADE
    JSR $920B
    LDA #$03
    JSR $9627
L_1C:0AE6: ; 1C:0AE6, 0x038AE6
    LDA #$5E
    JMP SND_BANKED_DISPATCH
L_1C:0AEB: ; 1C:0AEB, 0x038AEB
...
L_1C:0B1A: ; 1C:0B1A, 0x038B1A
    ...
    RTS
L_1C:0B23: ; 1C:0B23, 0x038B23
    LDY TMP_08
    CPY #$00
    BNE L_1C:0B2F
    JSR $8164
    JMP $8B32
L_1C:0B2F: ; 1C:0B2F, 0x038B2F
    JSR $8145
    LDA #$3C
    ...
    ORA #$10
    STA OBJ_SECONDARY_SWITCH?[18],X
L_1C:0B49: ; 1C:0B49, 0x038B49
    RTS
L_1C:0B4A: ; 1C:0B4A, 0x038B4A
    LDA #$00
    JMP BANKED_PLAYER_UI_GAME_OVER_GFX
SWITCH_RTN_E: ; 1C:0B4F, 0x038B4F
    LDY TMP_08
    LDA 85_PLAYER_UNK?[2],Y
    JSR SWITCH_CODE_PTRS_PAST_JSR
    ADC [BG_UPDATE_FLAG_UNK,X]
    LDY #$8C
    LDA #$8C
    AND #$8E
    AND 8D_UNK,X
    ...
    CMP #$07
    BNE L_1C:0BA2
L_1C:0B98: ; 1C:0B98, 0x038B98
    LDA #$3C
    JMP $8BA4
L_1C:0B9D: ; 1C:0B9D, 0x038B9D
    LDA #$3D
    JMP $8BA4
L_1C:0BA2: ; 1C:0BA2, 0x038BA2
    LDA #$3B
    JMP SND_BANKED_DISPATCH
L_1C:0BA7: ; 1C:0BA7, 0x038BA7
    LDA #$00
    STA PLAYERS_UNK[2],Y
    LDA #$3E
    JSR SND_BANKED_DISPATCH
    ...
    AND #$40
    ORA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
    STA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
    AND #$40
    BEQ L_1C:0BDE
...
L_1C:0C31: ; 1C:0C31, 0x038C31
    ...
    LDA 4C6_OBJ_UNK[18],X
    STA 4C6_OBJ_UNK+1,X
L_1C:0C5C: ; 1C:0C5C, 0x038C5C
    INX
    LDA #$09
    JSR $9627
    DEX
L_1C:0C63: ; 1C:0C63, 0x038C63
    LDY #$00
    JSR $8C7C
    LDA #$00
    STA 544_OBJ_UNK_POS_DELTA?[18],X
...
L_1C:0CEA: ; 1C:0CEA, 0x038CEA
    ...
    BCC L_1C:0D1B
    BEQ L_1C:0D1B
L_1C:0D16: ; 1C:0D16, 0x038D16
    LDA #$00
    STA A0_PLAYER_UNK[2],Y
L_1C:0D1B: ; 1C:0D1B, 0x038D1B
    RTS
L_1C:0D1C: ; 1C:0D1C, 0x038D1C
    JSR $8D3F
...
L_1C:0D3F: ; 1C:0D3F, 0x038D3F
    LDA 532_OBJ_UNK_POS_DELTA?[18],X
    BMI L_1C:0D48
    CMP #$08
    BCS L_1C:0D5F
L_1C:0D48: ; 1C:0D48, 0x038D48
    LDA 544_OBJ_UNK_POS_DELTA?[18],X
    CLC
    ADC 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X
    STA 544_OBJ_UNK_POS_DELTA?[18],X
    LDA 532_OBJ_UNK_POS_DELTA?[18],X
    ADC #$00
    STA 532_OBJ_UNK_POS_DELTA?[18],X
...
L_1C:0D74: ; 1C:0D74, 0x038D74
    ...
    STA 4C6_OBJ_UNK[18],X
    JMP $8DCB
L_1C:0D90: ; 1C:0D90, 0x038D90
    LDA 4C6_OBJ_UNK[18],X
    BPL L_1C:0D98
    JMP $8E1A
L_1C:0D98: ; 1C:0D98, 0x038D98
    CMP #$20
    BCS L_1C:0E1A
    LDA #$00
...
L_1C:0DA6: ; 1C:0DA6, 0x038DA6
    ...
    STA A0_PLAYER_UNK[2],Y
    BEQ L_1C:0E1A
L_1C:0DC0: ; 1C:0DC0, 0x038DC0
    LDA #$00
    STA 4D8_OBJ_UNK[18],X
    LDA A0_PLAYER_UNK[2],Y
    STA 4C6_OBJ_UNK[18],X
L_1C:0DCB: ; 1C:0DCB, 0x038DCB
    LDA LEVEL/SCREEN_ON
    CMP #$07
    BEQ L_1C:0DD8
    INX
...
L_1C:0DD8: ; 1C:0DD8, 0x038DD8
    ...
    LDA #$00
    BEQ L_1C:0E03
L_1C:0E01: ; 1C:0E01, 0x038E01
    LDA #$03
L_1C:0E03: ; 1C:0E03, 0x038E03
    STA 85_PLAYER_UNK?[2],Y
    LDA #$06
    JSR RTN_UNK_RTS_CARRY_SET_FAIL?
    BCC L_1C:0E15
    ...
    ORA #$20
    STA OBJ_SECONDARY_SWITCH?[18],X
L_1C:0E15: ; 1C:0E15, 0x038E15
    LDA #$08
    JMP $9627
L_1C:0E1A: ; 1C:0E1A, 0x038E1A
    LDY TMP_08
    LDA OBJ_POS_Y_CONFIRMED[18],X
    CMP #$2C
    BCS L_1C:0E28
...
SWITCH_RTN_A: ; 1C:0E31, 0x038E31
    ...
    LDY 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X
    LDA #$00
    STA 45A_OBJ_DATA_ENTRY?STATE_STEP?[18],Y
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
    AND #$BF
    STA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],Y
...
L_1C:0E9F: ; 1C:0E9F, 0x038E9F
    ...
    CMP #$07
    BCC L_1C:0EB6
L_1C:0EB0: ; 1C:0EB0, 0x038EB0
    JSR $8EC5
L_1C:0EB3: ; 1C:0EB3, 0x038EB3
    JMP $91E5
L_1C:0EB6: ; 1C:0EB6, 0x038EB6
    LDY TMP_08
    LDA CTRL_NEWLY_PRESSED_A[2],Y
    BEQ L_1C:0EC0
    INC 5C2_OBJ_DATA_PTR/MISC_INDEX[18],X
L_1C:0EC0: ; 1C:0EC0, 0x038EC0
    JSR $8ECE
    BNE L_1C:0ECD
    LDY 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X
    LDA #$01
    STA OBJ_TERTIARY_SWITCH?[18],Y
L_1C:0ECD: ; 1C:0ECD, 0x038ECD
    RTS
    LDY TMP_08
    ...
    LDA #$00
    STA OBJECT_DATA_HEALTH?[18],X
L_1C:0EF1: ; 1C:0EF1, 0x038EF1
    LDA #$05
    STA OBJECT_DATA_EXTRA_B?[18],X
    LDA #$00
    STA 85_PLAYER_UNK?[2],Y
L_1C:0EFB: ; 1C:0EFB, 0x038EFB
    LDA #$01
    STA 662_PLAYER_UPDATE_UNK[2],Y
    LDA OBJECT_DATA_HEALTH?[18],X
L_1C:0F03: ; 1C:0F03, 0x038F03
    RTS
SWITCH_RTN_B: ; 1C:0F04, 0x038F04
    ...
    LDA #$D8
    BNE L_1C:0F1B
L_1C:0F19: ; 1C:0F19, 0x038F19
    LDA #$2F
L_1C:0F1B: ; 1C:0F1B, 0x038F1B
    STA TMP_02
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
    AND #$40
    BEQ L_1C:0F28
...
L_1C:0F66: ; 1C:0F66, 0x038F66
    ...
    LDA #$26
    STA OBJ_ANIMATION_DISPLAY[18],Y
L_1C:0F80: ; 1C:0F80, 0x038F80
    LDA 5C2_OBJ_DATA_PTR/MISC_INDEX[18],X
    CMP #$04
    BCC L_1C:0F8D
    JSR $8F9C
    JMP $91E5
L_1C:0F8D: ; 1C:0F8D, 0x038F8D
    LDY TMP_08
    LDA CTRL_NEWLY_PRESSED_A[2],Y
    BEQ L_1C:0F97
    INC 5C2_OBJ_DATA_PTR/MISC_INDEX[18],X
L_1C:0F97: ; 1C:0F97, 0x038F97
    JSR $8ECE
    BNE L_1C:0FAE
    LDY 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X
    LDA #$01
    ...
    STA 8F_ARR_UNK[2],Y
    LDY 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X
L_1C:0FAE: ; 1C:0FAE, 0x038FAE
    RTS
L_1C:0FAF: ; 1C:0FAF, 0x038FAF
    JSR $8FA4
    JMP $91E5
SWITCH_RTN_D: ; 1C:0FB5, 0x038FB5
    ...
    BNE L_1C:0FD5
    LDA #$3E
L_1C:0FD5: ; 1C:0FD5, 0x038FD5
    JSR LEVEL_RELATED_DATA_A_PASSED?
    PLA
    TAX
    LDA #$20
    JMP SND_BANKED_DISPATCH
L_1C:0FDF: ; 1C:0FDF, 0x038FDF
    DEC 5C2_OBJ_DATA_PTR/MISC_INDEX[18],X
    BNE L_1C:0FAE
    TXA
    PHA
    ...
    LDX #$11
    BNE L_1C:0FF4
L_1C:0FF0: ; 1C:0FF0, 0x038FF0
    LDA TURTLE_SELECTION+1
    LDX #$15
L_1C:0FF4: ; 1C:0FF4, 0x038FF4
...
SWITCH_RTN_C: ; 1C:101A, 0x03901A
    ...
    STA 45A_OBJ_DATA_ENTRY?STATE_STEP?[18],Y
    RTS
L_1C:1059: ; 1C:1059, 0x039059
    JSR $8ECE
    BNE L_1C:1061
    JMP $8F9C
L_1C:1061: ; 1C:1061, 0x039061
    LDA CTRL_NEWLY_PRESSED_A[2],Y
    AND #$40
    BNE L_1C:1073
    LDY 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X
...
L_1C:1073: ; 1C:1073, 0x039073
    ...
    JSR UPDATE_PLAY_SCORE_AND_DISPLAY
    JMP $91E5
L_1C:1092: ; 1C:1092, 0x039092
    LDA #$04
    STA OBJ_ANIM_HOLD_TIMER?[18],X
    LDY TMP_08
    LDA #$02
    STA 85_PLAYER_UNK?[2],Y
L_1C:109E: ; 1C:109E, 0x03909E
    RTS
L_1C:109F: ; 1C:109F, 0x03909F
    ...
    STA 85_PLAYER_UNK?[2],Y
    RTS
L_1C:10C6: ; 1C:10C6, 0x0390C6
    LDY #$00
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
    AND #$40
    BEQ L_1C:10D1
    LDY #$04
L_1C:10D1: ; 1C:10D1, 0x0390D1
    STY TMP_02
    LDY 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X
    LDA 45A_OBJ_DATA_ENTRY?STATE_STEP?[18],Y
    ASL A
...
SWITCH_RTN_H: ; 1C:112E, 0x03912E
    ...
    LDA #$41
    JMP SND_BANKED_DISPATCH
L_1C:114C: ; 1C:114C, 0x03914C
    LDA 5C2_OBJ_DATA_PTR/MISC_INDEX[18],X
    AND #$07
    BNE L_1C:1158
    LDA #$41
    JSR SND_BANKED_DISPATCH
L_1C:1158: ; 1C:1158, 0x039158
    DEC 5C2_OBJ_DATA_PTR/MISC_INDEX[18],X
    BNE L_1C:11A7
    JMP $91E5
...
L_1C:117B: ; 1C:117B, 0x03917B
    ...
    STA 662_PLAYER_UPDATE_UNK[2],Y
    RTS
L_1C:118E: ; 1C:118E, 0x03918E
    LDA 5C2_OBJ_DATA_PTR/MISC_INDEX[18],X
    AND #$07
    BNE L_1C:119A
    LDA #$41
    JSR SND_BANKED_DISPATCH
L_1C:119A: ; 1C:119A, 0x03919A
    DEC 5C2_OBJ_DATA_PTR/MISC_INDEX[18],X
    BNE L_1C:11A7
    JSR $91E5
    LDA #$20
    STA 93_PLAYER_UNK[2],Y
L_1C:11A7: ; 1C:11A7, 0x0391A7
    RTS
...
L_1C:11C1: ; 1C:11C1, 0x0391C1
    ...
    BEQ L_1C:11DE
    ORA #$01
L_1C:11DE: ; 1C:11DE, 0x0391DE
    STA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X
    JSR UPDATE_PLAYER_HEALTH
L_1C:11E4: ; 1C:11E4, 0x0391E4
    RTS
    LDY TMP_08
    LDA #$00
    STA 85_PLAYER_UNK?[2],Y
...
L_1C:125A: ; 1C:125A, 0x03925A
    ...
    LDA #$00
    STA OBJECT_DATA_HEALTH?[18],X
L_1C:1271: ; 1C:1271, 0x039271
    LDA #$05
    STA OBJECT_DATA_EXTRA_B?[18],X
    BNE L_1C:1285
L_1C:1278: ; 1C:1278, 0x039278
    LDA OBJ_SECONDARY_SWITCH?[18],X
    AND #$F0
    STA OBJ_SECONDARY_SWITCH?[18],X
    LDA #$00
    STA OBJECT_DATA_EXTRA_B?[18],X
L_1C:1285: ; 1C:1285, 0x039285
    LDA #$00
    STA 85_PLAYER_UNK?[2],Y
    LDA #$50
    STA 93_PLAYER_UNK[2],Y
...
TURTLE_SELECT_RTN_1: ; 1C:12B1, 0x0392B1
    ...
    AND #$01 ; Get 0/1
    ORA TWO_PLAYERS_FLAG ; Or with...?
    STA TWO_PLAYERS_FLAG ; Store...
    LDA #$05
...
SKIP_Y_NEGATIVE: ; 1C:12E1, 0x0392E1
    STY TURTLE_SELECTION+1 ; Store 1 or FF.
    LDA #$05
...
COUNTER_NOT_TRIGGERED_A?: ; 1C:1374, 0x039374
    ...
    STY OBJ_ANIMATION_DISPLAY+1 ; Clear.
SHIFTED_1_TO_CARRY: ; 1C:1384, 0x039384
    LSR A ; >> 1
    BCS DATA_NOT_ZERO ; If we shift off a 1, goto.
    STY OBJ_ANIMATION_DISPLAY[18] ; Clear val.
DATA_NOT_ZERO: ; 1C:138A, 0x03938A
    LDA TURTLE_SELECTION[2] ; Load val
    STA TMP_08 ; P1 previous
    LDA TURTLE_SELECTION+1 ; Load val
    ...
    LDA TURTLE_SELECTION+1 ; Load pos.
...
PLAYER_2_CONFIRMED: ; 1C:13AA, 0x0393AA
    ...
    LDA TURTLE_SELECTION[2] ; Load P1 Pos.
...
SELECTION_NOT_SAME_AS_PREV: ; 1C:13CA, 0x0393CA
    ...
    BCC L_1C:13D9
    LDA #$12
L_1C:13D9: ; 1C:13D9, 0x0393D9
    LDY TURTLE_SELECTION[2],X
    JSR TURTLE_SELECTION_ATTR_UPDATE
    LDA TURTLE_SELECTION[2]
    STA TMP_0A
    LDA TURTLE_SELECTION+1
...
U/D_NOT_PRESSED: ; 1C:13F5, 0x0393F5
    ...
    BEQ L_1C:13FD ; Not pressed, goto.
    JSR TSELECT_INVERT_COLUMN ; Pressed, do rtn.
L_1C:13FD: ; 1C:13FD, 0x0393FD
    RTS ; Leave, modded.
...
TSELECT_INVERT_ROW: ; 1C:140E, 0x03940E
    ...
    LDA TURTLE_SELECTION[2],X ; Load editing.
    EOR #$02 ; Invert row.
    CMP TURTLE_SELECTION[2],Y ; CODE MISTAKE: Not ZP mode. Compare to other player.
    BEQ LEAVE_NO_MOD ; Other player has selected, abort.
    STA TURTLE_SELECTION[2],X ; Otherwise, store.
    PHA ; Save A.
    LDA #$56
    JSR SND_BANKED_DISPATCH ; Play sound.
    PLA ; Restore A.
...
RTN_CURSOR_OBJECT_UPDATE?: ; 1C:1500, 0x039500
    ...
    LDA TURTLE_SELECTION[2] ; A=Selected pos.
...
TSELECT_FINAL_ANIM_TIMEOUT/SKIP: ; 1C:1569, 0x039569
    LDA TWO_PLAYERS_FLAG ; Not really sure if flag or val.
    BNE SINGLE_PLAYER_GAME? ; != 0, goto.
    STA TURTLE_SELECTION+1 ; Store to select?
SINGLE_PLAYER_GAME?: ; 1C:156F, 0x03956F
    ...
    INX ; P2?
    JSR INIT_OBJECT[X]_DATA_FULL
    JMP SOUND_RESET/INIT_RTN? ; Sound init, abuse RTS.
OBJECT_X_DO_UNK: ; 1C:1589, 0x039589
    LDA 544_OBJ_UNK_POS_DELTA?[18],X ; Load
    ORA 532_OBJ_UNK_POS_DELTA?[18],X ; Or with
...
VALUES_NOT_SET_A: ; 1C:15AC, 0x0395AC
    LDA OBJ_POS_X_SUBPIXEL_DELTA?[18],X ; Load value.
...
VAL_ABOVE_#$80: ; 1C:163F, 0x03963F
    ...
    STA TMP_00 ; Store to.
    LDY TMP_08 ; Y from.
    LDA TURTLE_SELECTION[2],Y ; Get selected.
    CLC
    ADC TMP_00 ; Add with.
    TAY ; To Y index.
...
SKIP_TO_UNK: ; 1C:165C, 0x03965C
    ...
    STA 45A_OBJ_DATA_ENTRY?STATE_STEP?[18],X ; Clear unk.
...
REENTER_UNK: ; 1C:16F4, 0x0396F4
    LDA 45A_OBJ_DATA_ENTRY?STATE_STEP?[18],X ; Load val from object.
    INC 45A_OBJ_DATA_ENTRY?STATE_STEP?[18],X ; ++ val.
...
INJECT_ANIMATION_FROM_A: ; 1C:1715, 0x039715
    STA OBJ_ANIMATION_DISPLAY[18],X ; Switch animation frames?
    INY ; Stream++
    LDA [TMP_00],Y ; Load from stream.
    CMP #$FF ; If _ #$FF
    ...
    STA SCRIPT_R0-R5_GFX_BANK_VALS+2 ; Change P1 animation GFX.
    JMP STREAM_MARK_B_FF
CHANGE_PLAYER_TWO_GFX: ; 1C:172C, 0x03972C
    STA SCRIPT_R0-R5_GFX_BANK_VALS+3 ; Store P2 GFX.
