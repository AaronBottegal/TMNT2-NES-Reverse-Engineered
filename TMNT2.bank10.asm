...
SKIP_SET_FLAG_A: ; 0A:08E0, 0x0148E0
    STA OBJ_STATE_DIR_RELATED_C[18],X ; Store direction.
    LDY #$00 ; Seed val.
    BCS SKIP_SET_FLAG_B
...
X_LARGER: ; 0A:0997, 0x014997
    STA OBJ_STATE_DIR_RELATED_C[18],X ; A to direction.
...
SHIFTED_ONE: ; 0A:0A65, 0x014A65
    STA OBJ_STATE_DIR_RELATED_C[18],X ; Set
...
SKIP_OTHER_ANIMATION: ; 0A:0F50, 0x014F50
    ...
    JSR MOVE_UNK_RET_?? ; Do.
    LDA 45A_OBJ_DATA_ENTRY?STATE_STEP?+1,X ; Load pair.
    CMP OBJ_POS_Y?[18],X ; If _ var
    BCC SKIP_UNK ; <, goto.
    STA OBJ_POS_Y?[18],X ; Store from pair to.
    INC OBJ_POS_Y?[18],X ; ++
...
LOAD_NEGATIVE: ; 0A:12F3, 0x0152F3
    ...
    STA OBJ_POS_X?[18],X ; Store to Xobj.
