...
STATE_NE_0x81: ; 00:0047, 0x000047
    ...
    CMP #$02 ; If _ #$02
    BCS INC_OBJ_DATA_UNK ; >=, goto.
    JSR RTN_GET_OBJ_PAIR_IN_T_RET_CC_SUCCESS ; Get objs.
    BCS INC_OBJ_DATA_UNK ; Failed, skip.
    LDA OBJ_POS_X[18],X ; Copy pos.
    STA OBJ_POS_X[18],Y
    LDA 4A2_OBJ_UNK_POS?[18],X ; Copy
    STA 4A2_OBJ_UNK_POS?[18],Y
    LDA OBJ_POS_Y[18],X ; Copy Y
    STA OBJ_POS_Y[18],Y
    ...
    LDA #$00
    STA 556_OBJ_UPDATE_FLAGS?[18],Y ; Clear.
DEC_TIMER_UNK: ; 00:007A, 0x00007A
    DEC 59E_OBJ_UNK[18],X ; --
INC_OBJ_DATA_UNK: ; 00:007D, 0x00007D
    INC 45A_OBJ_DATA_ENTRY?[18],X ; ++ idk.
...
L_00:00DC: ; 00:00DC, 0x0000DC
    ...
    CMP 5C2_OBJ_DATA_PTR/MISC_INDEX[18],X
    BCC L_00:0126
