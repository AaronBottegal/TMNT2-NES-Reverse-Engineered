...
RTS: ; 0C:0026, 0x018026
    RTS ; Leave.
OBJ_MOD_BLINKING?_ATTR_MOD: ; 0C:0027, 0x018027
...
704_LT_DATA: ; 0C:005D, 0x01805D
    ...
    STA OBJ_STATE_DIR_RELATED_C[18],X ; Store back to obj.
...
ON_STADIUM_FIGHT: ; 0C:0215, 0x018215
    JMP CROSS_BANK_INTERFACE_UNKNOWN ; Goto, unk.
...
EXIT_CROSS_BANK: ; 0C:02AC, 0x0182AC
    JMP CROSS_BANK_INTERFACE_UNKNOWN ; Do cross bank.
...
OBJ_STATE_0x51_HANDLER: ; 0C:0315, 0x018315
    ...
    JSR OBJ_MOD_BLINKING?_ATTR_MOD
...
LT_0x04: ; 0C:09DE, 0x0189DE
    ...
    STA OBJ_STATE_DIR_RELATED_C[18],X ; Store. to.
    DEC 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X ; --
    BNE EXIT_MOVE ; != 0, goto.
...
VAL_NEG: ; 0C:15DD, 0x0195DD
    ...
    LDA #$00 ; Seed invert.
    SEC ; Prep sub.
    SBC 710_UNK ; Sub with, inverting.
    STA 710_UNK ; Store to.
...
UNK_PTRS2_H: ; 0C:185E, 0x01985E
    ...
    LOW(OLD_MS_F)
    HIGH(OLD_MS_F)
OLD_MS_A: ; 0C:1869, 0x019869
    LOW(RTN_A)
    HIGH(RTN_A)
OLD_MS_B: ; 0C:186B, 0x01986B
    LOW(RTN_A)
    HIGH(RTN_A)
    LOW(RTN_B)
    HIGH(RTN_B)
OLD_MS_C: ; 0C:186F, 0x01986F
    LOW(RTN_A)
    HIGH(RTN_A)
    LOW(RTN_B)
    HIGH(RTN_B)
    ...
    LOW(RTN_D)
    HIGH(RTN_D)
OLD_MS_D: ; 0C:1877, 0x019877
    LOW(RTN_A)
    HIGH(RTN_A)
    LOW(RTN_B)
    HIGH(RTN_B)
OLD_MS_E: ; 0C:187B, 0x01987B
    LOW(RTN_A)
    HIGH(RTN_A)
OLD_MS_F: ; 0C:187D, 0x01987D
    LOW(RTN_A)
    HIGH(RTN_A)
    LOW(RTN_B)
    HIGH(RTN_B)
...
VAL_GTE_0xC6: ; 0C:1952, 0x019952
    JSR ADD_MIN_HELPER ; Do.
    JMP ANIM_DISP_SOLVER ; Goto, abuse RTS.
EXIT_GFX: ; 0C:1958, 0x019958
    ...
    LDA #$14
    STA 45A_OBJ_DATA_ENTRY?STATE_STEP?[18],X ; Set attr.
    JSR ANIM_DISP_SOLVER ; Anim disp.
    JMP XOBJ_MANIP_BASED_ON_LIVES_UNK ; Goto, abuse RTS.
...
RTN_A: ; 0C:1A8C, 0x019A8C
    ...
    SEC
    LDA #$00
    SBC 544_OBJ_UNK_POS_DELTA?[18],X
    STA 544_OBJ_UNK_POS_DELTA?[18],X
    LDA #$00
    SBC 532_OBJ_UNK_POS_DELTA?[18],X
    STA 532_OBJ_UNK_POS_DELTA?[18],X
    CLC
...
OBJ_DATA_C: ; 0C:1B70, 0x019B70
    ...
    .db 80
    .db 80
ANIM_DISP_SOLVER: ; 0C:1B80, 0x019B80
...
ROM_ATTR_B: ; 0C:1BEB, 0x019BEB
    .db FC
ROM_ATTR_A: ; 0C:1BEC, 0x019BEC
    .db 00
ROM_ATTR_B: ; 0C:1BED, 0x019BED
    .db 04
    .db 00
    .db 00
...
RTN_B: ; 0C:1C30, 0x019C30
    ...
    EOR #$02
    STA 5D4_EXTRA_TIMER/OBJ/FOCUS[18],X
    JMP XOBJ_MANIP_BASED_ON_LIVES_UNK
    STA OBJ_ANIMATION_DISPLAY[18],X
    JSR 0C:1CF1
    LDA #$18
...
OBJ_STATE_0x59_HANDLER: ; 0C:1C92, 0x019C92
    ...
    BNE L_0C:1CDC
    JSR MOVE?_RTN_IDK
    BCS ANIM_HOLD/DISP/TERT_HELPER
    JSR XPOS_RTN_RET_??
    BCS EXIT_DIE
...
RE-ENTER: ; 0C:1E6F, 0x019E6F
    ...
    STA OBJ_STATE_DIR_RELATED_C[18],X ; Store back to Xobj.
    ASL A ; << 2, *4.
    ASL A
    LDY #$00 ; Index
