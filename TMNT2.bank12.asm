...
L_0C:00EC: ; 0C:00EC, 0x0180EC
    ...
    STA 59E_OBJ_UNK/EXTRA_TIMER[18],X
    LDA #$FF
    STA 503_OBJ_POS_X_LARGEST?+2,X
    LDA #$80
    STA 520_OBJ_POS_X_LARGE?+2,X
    LDA #$0C
...
L_0C:0215: ; 0C:0215, 0x018215
    JMP CROSS_BANK_INTERFACE_UNKNOWN
...
L_0C:042D: ; 0C:042D, 0x01842D
    JSR SUB_CONDITIONALLY_SET_FLAG_UNK
    JSR FIND_POS_DIFF_X+YOBJ_XPOS_TMP_FLAGS
    CMP #$1C
    BCC L_0C:0451
    LDA #$00
...
OBJ_STATE_0x58_HANDLER: ; 0C:1B9F, 0x019B9F
    ...
    LDA OBJ_POS_X_SUBPIXEL?+17,X
    STA OBJ_POS_Y[18],X
    LDA OBJ_ANIMATION_DISPLAY+17,X ; Load from Obj[17]
    CMP #$02 ; If _ #$02
    LDA #$00 ; Seed val.
