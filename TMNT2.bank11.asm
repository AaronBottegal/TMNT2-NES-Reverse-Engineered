...
HEALTH_NONZERO: ; 0B:029E, 0x01629E
    ...
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],Y ; Load from Y.
    ASL A ; << 2, *4.
    ASL A
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X ; A from X
    AND #$BF ; Keep 1011.1111
    BCC BIT_0x40_NOT_SET
    ORA #$40 ; Set if was.
BIT_0x40_NOT_SET: ; 0B:02CD, 0x0162CD
    STA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],X ; Store to X.
    LDY #$00 ; Data index.
...
HEALTH_ZERO_ENTRY: ; 0B:0326, 0x016326
    ...
    LDA OBJ_STATE_DIR_RELATED_C_SPR_DATA?[18],Y ; A from Y.
    JMP LT_0x04 ; Goto.
...
ALT_ENTER: ; 0B:03A2, 0x0163A2
    JSR MOVE_UNK_RET_CS_POS_CS_NEG_ADD_USE ; Do rtn.
...
VAL_EQ_ZERO: ; 0B:0453, 0x016453
    JSR MOVE_UNK_RET_CS_POS_CS_NEG ; Do rtn.
...
SHIFT_RESULT_CS: ; 0B:04B7, 0x0164B7
    ...
    ADC OBJ_POS_X_CONFIRMED[18],X ; Add
...
RTN_NEW_OBJ_UNK: ; 0B:04FD, 0x0164FD
    ...
    LDA OBJ_POS_X_CONFIRMED[18],Y ; Copy from handling to new.
...
UNUSED_OBJ_EXISTS: ; 0B:073B, 0x01673B
    ...
    LDA OBJ_POS_X_CONFIRMED[18],Y ; YOBJ to XOBJ
    STA OBJ_POS_X_CONFIRMED[18],X
    LDA OBJ_POS_X??[18],Y
    STA OBJ_POS_X??[18],X
